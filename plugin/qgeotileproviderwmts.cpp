...
QGeoTileProviderWmts::QGeoTileProviderWmts(
...
, m_cameraCapabilities(cameraCapabilities)
{
    ...
    connect(this, &QGeoTileProviderWmts::resolutionFinished, this, &QGeoTileProviderWmts::updateCameraCapabilities);
}

QUrl QGeoTileProviderWmts::tileAddress(int x, int y, int z) const
{
...
QString QGeoTileProviderWmts::mapCopyRight() const
{
    if (m_status != Resolved || !m_provider) {
        return QString();
    }
...
QString QGeoTileProviderWmts::dataCopyRight() const
{
    if (m_status != Resolved || !m_provider) {
        return QString();
    }
...
QString QGeoTileProviderWmts::styleCopyRight() const
{
    if (m_status != Resolved || !m_provider) {
        return QString();
    }
...
QString QGeoTileProviderWmts::format() const
{
    if (m_status != Resolved || !m_provider) {
        return QString();
    }
...
int QGeoTileProviderWmts::minimumZoomLevel() const
{
    if (m_status != Resolved || !m_provider) {
        return 0;
    }
...
int QGeoTileProviderWmts::maximumZoomLevel() const
{
    if (m_status != Resolved || !m_provider) {
        return 20;
    }
...
bool QGeoTileProviderWmts::isHighDpi() const
{
    if (!m_provider) {
        return false;
    }
...
const QDateTime QGeoTileProviderWmts::timestamp() const
{
    if (!m_provider) {
        return QDateTime();
    }
...
QGeoCameraCapabilities QGeoTileProviderWmts::cameraCapabilities() const
{
    return m_cameraCapabilities;
}

const QGeoMapType& QGeoTileProviderWmts::mapType() const
{
    return m_mapType;
}

bool QGeoTileProviderWmts::isValid() const
{
    if (m_status != Resolved || !m_provider) {
        return false;
    }
...
bool QGeoTileProviderWmts::isResolved() const
{
    return (m_status == Resolved);
}

void QGeoTileProviderWmts::resolveProvider()
{
    ...
    connect(m_provider, &TileProvider::resolutionFinished, this, &QGeoTileProviderWmts::onResolutionFinished);
    connect(m_provider, &TileProvider::resolutionError, this, &QGeoTileProviderWmts::onResolutionError);
    m_provider->resolveProvider();
}

void QGeoTileProviderWmts::disableRedirection()
{
    if (m_provider && m_provider->isValid()) {
        return;
    }
...
void QGeoTileProviderWmts::onResolutionFinished(TileProvider* provider)
{
    Q_UNUSED(provider)
...
void QGeoTileProviderWmts::onResolutionError(TileProvider* provider)
{
    Q_UNUSED(provider)
    // provider and m_provider are the same at this point. m_status is Resolving.
...
void QGeoTileProviderWmts::updateCameraCapabilities()
{
...
void QGeoTileProviderWmts::addProvider(TileProvider* provider)
{
    if (!provider) {
        return;
    }
...
void TileProvider::resolveProvider()
{
    ...
    request.setHeader(QNetworkRequest::UserAgentHeader, QByteArrayLiteral("QGeoTileFetcherWmts"));
...
void TileProvider::onNetworkReplyFinished()
{
    ...
    if (urlTemplate == QJsonValue::Undefined || imageFormat == QJsonValue::Undefined || copyRightMap == QJsonValue::Undefined || copyRightData == QJsonValue::Undefined || !urlTemplate.isString() || !imageFormat.isString() || !copyRightMap.isString() || !copyRightData.isString()) {
        qWarning() << "QGeoTileProviderOsm: Incomplete redirection data"
                   << "at " << m_urlRedirector;
        return;
    }
    ...
    if (enabled.isBool() && !enabled.toBool()) {
        qWarning() << "QGeoTileProviderOsm: Tileserver disabled"
                   << "at " << m_urlRedirector;
        return;
    }
